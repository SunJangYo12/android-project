...
public class AudioPreview
    ...
    public void onCreate(Bundle icicle) {
        ...
        mTextLine1 = (TextView) findViewById(R.id.audio_line1);
        mTextLine2 = (TextView) findViewById(R.id.audio_line2);
        mLoadingText = (TextView) findViewById(R.id.audio_loading);
        if (scheme.equals("http")) {
            String msg = getString(R.string.app_name, mUri.getHost());
            mLoadingText.setText(msg);
        } else {
            mLoadingText.setVisibility(View.GONE);
        }
        mSeekBar = (SeekBar) findViewById(R.id.audio_progress);
    ...
    private void showPostPrepareUI() {
        ProgressBar pb = (ProgressBar) findViewById(R.id.audio_spinner);
        ...
        mLoadingText.setVisibility(View.GONE);
        View v = findViewById(R.id.audio_titleandbuttons);
    ...
    private void updatePlayPause() {
        ImageButton b = (ImageButton) findViewById(R.id.audio_playpause);
        if (b != null && mPlayer != null) {
            if (mPlayer.isPlaying()) {
                b.setImageResource(R.drawable.audio_imgpause);
            } else {
                b.setImageResource(R.drawable.audio_imgplay);
                mProgressRefresher.removeCallbacksAndMessages(null);
            }
        }
    }
