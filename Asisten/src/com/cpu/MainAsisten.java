...
import android.os.*;
import com.cpu.input.MicApi;
import com.cpu.init.KalenderKu;
import java.util.*;
...
{ 
	...
	public String help = "WAJIB INSTALL GOOGLE SEARCH TERBARU\n"+
						...
						"1. waktu : -cuaca -> (di) misal wonosobo (refresh) untuk perbarui data cuaca (hari -> (ini) (besok) )"+
									"-hari ngomong hari ini\n"+
									"-tanggal hari ini\n"+
									"-jam ngomong jam sekarang\n"+
						 "2. hemat : on/off pendengaran, jika dipanggil maka off dan jika dipanggil lagi on\n"+
						 "3. ngobrol: -halo untuk ngtes\n"+
						 ...
						 "4. alat :   -senter -> (berkedip:senter akan kedip2)\n"+
						 			" -kompas membuka kompas\n"+
						 "5. status : -status -> (proses:lihat persen cpu) (aplikasi:list semua aplikasi) (baterai:(tegangan) (arus) (suhu) )\n"+
						 "6. file :   -file -> (cari: (bernama) (format) (external/internal) )\n"+
						 "7. pengaturan : configure semua\n"+
						 "8. server : configurasi server";
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		rece.btnServer = false;
		edt = (EditText)findViewById(R.id.main_edit);
		btn = (Button)findViewById(R.id.main_btn);

		String[] aksi ={"Browser","File Manager","Terminal Emulator","INDEX console","INDEX speech"};
